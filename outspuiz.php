...
$(document).ready(function() {
  ...
  $('#toggler').on("click", function (){
    $('#cruds_cont').toggleClass('toggle_form');

    if ($('#cruds_cont').hasClass('toggle_form'))
      this.innerHTML = "Show";
    else
      this.innerHTML = "Hide";
  });
  ...
  $('#name').on("focus", function () {
    $('#tooltip_name').fadeIn(200);
  });

  $('#name').on("focusout", function () {
    $('#tooltip_name').fadeOut(0);
  });

  $('#age').on("focus", function () {
    $('#tooltip_age').fadeIn(200);
  });

  $('#age').on("focusout", function () {
    $('#tooltip_age').fadeOut(0);
  });

  $('#email').on("focus", function () {
    $('#tooltip_email').fadeIn(200);
  });

  $('#email').on("focusout", function () {
    $('#tooltip_email').fadeOut(0);
  });

  $('#phone').on("focus", function () {
    $('#tooltip_phone').fadeIn(200);
  });

  $('#phone').on("focusout", function () {
    $('#tooltip_phone').fadeOut(0);
  });
...
<body>
  ...
  <div id="main_cont">
    ...
    <div id="tooltip_name">
      <div id="panel_title">You must enter your full name in this field.</div>
    </div>

    <div id="tooltip_age">
      <div id="panel_title">You must enter your full age in this field. <i>For Example: (Enter the number 5 if you are 5 years old.)</i></div>
    </div>

    <div id="tooltip_email">
      <div id="panel_title">You must enter your personal email in this field. <i>For Example: sample@gmail.com</i></div>
    </div>
    
    <div id="tooltip_phone">
      <div id="panel_title">You must enter your phone number in this field.</div>
    </div>
    </div>
  </div>
